...
```bash
sh -c "`curl -fsSL https://raw.github.com/mlaferrera/dotfiles/master/install.sh`"
```
...
```bash
sh -c "`curl -fsSL https://raw.github.com/mlaferrera/dotfiles/master/install.sh`" -s ask
```
